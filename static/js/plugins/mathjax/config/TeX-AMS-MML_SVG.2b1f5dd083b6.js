...
MathJax.Extension.mml2jax = {
    ...
    PreProcess: function(e) {
        ...
        var h = [];
        h.push.apply(h, e.getElementsByTagName("math"));
        if (e.getElementsByTagNameNS) {
            h.push.apply(h, e.getElementsByTagNameNS(this.MMLnamespace, "math"))
        }
        var d, b;
            ...
            try {
                for (d = 0, b = document.namespaces.length; d < b; d++) {
                    ...
                    if (f.urn === this.MMLnamespace) {
                        h.push.apply(h, e.getElementsByTagName(f.name + ":math"))
                    }
                }
            } catch (g) {}
        } else {
            ...
            if (c) {
                for (d = 0, b = c.attributes.length; d < b; d++) {
                    ...
                    if (a.nodeName.substr(0, 6) === "xmlns:" && a.nodeValue === this.MMLnamespace) {
                        h.push.apply(h, e.getElementsByTagName(a.nodeName.substr(6) + ":math"))
                    }
                }
            }
        }
